		...
		<div class="single-bottom">
			...
			<h3>Viết bình luận</h3>
				...
				<input type="hidden" name="_token" value="{{csrf_token()}}">
						...
						<input type="text" value="{{Auth::User()->name}}" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='{{Auth::User()->name}}';}">
						</div>
						<div class="col-md-4 comment">
						<input type="text" value="{{Auth::User()->email}}" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='{{Auth::User()->email}}';}">
						</div>
